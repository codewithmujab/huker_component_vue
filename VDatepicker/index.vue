<template>
    <div class="relative">
        <flat-pickr class="form-calender pl-9 text-slate-500 hover:text-slate-600 font-medium focus:border-slate-300 w-60"
...
const props = defineProps({
    align: oneOf(['right', 'left']).def('right'),
    isRange: bool().def(false)
})
