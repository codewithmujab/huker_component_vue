...
const props = defineProps({
    bg: oneOf(['dark', 'white']).def('white'),
    size: oneOf(['lg', 'md', 'sm', 'default']).def('default'),
    position: oneOf(['right', 'left', 'bottom', 'top']).def('top'),
})
...
<template>
    <div class="relative" @mouseenter="tooltipOpen = true" @mouseleave="tooltipOpen = false" @focusin="tooltipOpen = true"
